// ── QA hub ───────────────────────────────────────────────────────────────────
// The compass rose of the suite: nine doorways to the labs, the curator's
// teleport menu, the grand-tour quest, the feature matrix, a save terminal,
// and the gated completion terminal.
...
export const hubWing: QaWing = {
  ...
  dialogue: [
    say(
      "qa_dlg_suite_intro",
      "QA Curator",
      "Engine QA Suite online. Nine labs, one hub. The chemistry wing is north and east — flood a chamber, race two liquids, burn a gallery, vent a vault. When all four releases have fired, the completion terminal behind me unlocks.",
      [{ text: "Begin." }],
    ),
