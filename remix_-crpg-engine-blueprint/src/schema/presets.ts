...
} from "../data/playerGuitarAssets";
import {
  BACKROOMS_PARASITE_MODEL,
  BACKROOMS_PARASITE_MODEL_OBJECT_ID,
} from "../data/backroomsEntityAssets";
import { LONELY_STREET_HOUSE_INTERIOR_OBJECTS } from "../data/lonelyStreetHouseInteriorAssets";
import { LONELY_STREET_BASEMENT_OBJECTS } from "../data/lonelyStreetBasementAssets";
import {
...
import { LONELY_STREET_FRONT_DOOR_OBJECT_ID } from "../utils/doorPlacement";

export { LONELY_STREET_FRONT_DOOR_OBJECT_ID } from "../utils/doorPlacement";
...
export const LONELY_STREET_GRASS_OBJECT_ID = "obj_lonely_street_grass";
export const LONELY_STREET_TREE_OBJECT_ID = "obj_lonely_street_pine";
export const LONELY_STREET_ROAD_MARKER_OBJECT_ID =
  "obj_lonely_street_road_marker";
export const LONELY_STREET_HOUSE_OBJECT_ID = "obj_lonely_street_house";
...
const LONELY_STREET_MATERIALS = {
  asphalt: "mat_lonely_street_asphalt",
  sidewalk: "mat_lonely_street_sidewalk",
  grass: "mat_lonely_street_grass",
  roadMarker: "mat_lonely_street_road_marker",
  houseSiding: "mat_lonely_street_house_siding",
  houseTrim: "mat_lonely_street_house_trim",
  houseRoof: "mat_lonely_street_house_roof",
  houseDoor: "mat_lonely_street_house_door",
  houseWindow: "mat_lonely_street_house_window",
  porchLight: "mat_lonely_street_porch_light",
} as const;
...
): ObjectData["simulation"] | undefined =>
  simulation
    ? {
        condition: "intact",
        integrity: 1,
...
const roofObject = (
  ...
  displayName: string,
  accent:
    "flat" | "north" | "south" | "east" | "west" | "nw" | "ne" | "se" | "sw",
  baseColor = "#8B5A2B",
  trimColor = "#5C2E1D",
): ObjectData => {
  ...
  if (accent !== "flat") {
    ...
    accentParts.push(
      part(
        ...
        "eave",
        [
          accent.includes("w") || accent === "west"
            ? -0.34
            : accent.includes("e") || accent === "east"
              ? 0.34
              : 0,
          0.15,
          accent.includes("n") || accent === "north"
            ? -0.34
            : accent.includes("s") || accent === "south"
              ? 0.34
              : 0,
        ],
        corner
...
const baseObjectLibraryPresets: ObjectData[] = [
  ...
  },
  {
    ...object(
      ...
      "structure",
      ["wall", "tile", "wallpaper", "backrooms", "level_zero", "institutional"],
      [1.04, 1.84, 1.04],
      [
        part(
          "box",
    ...
    material_settings: [
      {
        ...
        // muted self-bounce so it reads as stained tile inside the halo instead
  ...
  ),
  {
    ...object(
      ...
      "Lonely Street Asphalt",
      "terrain",
      ["tile", "ground", "floor", "road", "asphalt", "exterior"],
      [1, 0.04, 1],
      [
        part(
          "box",
          ...
          [0, 0.015, 0],
          [1, 0.03, 1],
          LONELY_STREET_MATERIALS.asphalt,
        ),
      ],
      { profile: "none", footprint: [[0, 0]] },
      [LONELY_STREET_MATERIALS.asphalt],
    ...
    material_settings: [
      {
        id: LONELY_STREET_MATERIALS.asphalt,
        name: "Weathered charcoal asphalt",
        color: "#292d31",
        emissive: "#000000",
        emissive_intensity: 0,
        opacity: 1,
  ...
  },
  {
    ...object(
      ...
      "Lonely Street Sidewalk",
      "terrain",
      ["tile", "ground", "floor", "sidewalk", "concrete", "exterior"],
      [1, 0.09, 1],
      [
        part(
          "box",
          ...
          [0, 0.04, 0],
          [1, 0.08, 1],
          LONELY_STREET_MATERIALS.sidewalk,
        ),
      ],
      { profile: "none", footprint: [[0, 0]] },
      [LONELY_STREET_MATERIALS.sidewalk],
    ...
    material_settings: [
      {
        id: LONELY_STREET_MATERIALS.sidewalk,
        name: "Aged sidewalk concrete",
        color: "#8b8b83",
        emissive: "#000000",
        emissive_intensity: 0,
        opacity: 1,
  ...
  },
  {
    ...object(
      ...
      "Lonely Street Verge",
      "terrain",
      ["tile", "ground", "floor", "grass", "exterior"],
      [1, 0.05, 1],
      [
        part(
          "box",
    ...
    material_settings: [
      {
        id: LONELY_STREET_MATERIALS.grass,
        name: "Untended blue-green verge",
        color: "#344f36",
        emissive: "#000000",
        emissive_intensity: 0,
        opacity: 1,
  ...
  {
    id: LONELY_STREET_TREE_OBJECT_ID,
    display_name: "Lonely Street Autumn Tree",
    category: "nature",
    tags: [
      "prop",
      "nature",
    ...
    origin: "center_floor",
    bounds: [4.074466408610344, 4.394078744854778, 4.129398308694363],
    materials: ["lonely_street_autumn_tree_material"],
    material_settings: [],
    model_kind: "asset",
    parts: [],
    decals: [],
    reference_images: [],
    asset: {
      data_url: "/models/environment/autumn-tree.glb",
      filename: "autumn-tree.glb",
      source_type: "glb",
      offset: [0, 0, 0],
      rotation: [0, 0, 0],
      ...
      source_center: [
        0.004179731011390686,
        0.4851678526028991,
        -0.0034309476613998413,
      ],
      source_bounds: [
        0.9366588294506073,
        1.0101330447942019,
      ...
      material_names: ["lonely_street_autumn_tree_material"],
      stats: {
        meshes: 1,
        vertices: 2180,
        triangles: 1008,
  ...
  },
  {
    ...object(
      ...
      "Faded Road Center Marking",
      "terrain",
      ["prop", "road_marking", "exterior"],
      [0.12, 0.035, 1.45],
      [
        part(
          "box",
          ...
          [0, 0.027, 0],
          [0.11, 0.025, 1.4],
          LONELY_STREET_MATERIALS.roadMarker,
        ),
      ],
      { profile: "none", footprint: [[0, 0]] },
      [LONELY_STREET_MATERIALS.roadMarker],
    ...
    material_settings: [
      {
        id: LONELY_STREET_MATERIALS.roadMarker,
        name: "Faded ivory road paint",
        color: "#b9ad79",
        emissive: "#000000",
        emissive_intensity: 0,
        opacity: 1,
  ...
  },
  {
    ...object(
      ...
      [5.4, 4.15, 4.05],
      [
        part("box", "foundation", [0, 0.13, 0], [5.15, 0.26, 3.55], "#34373a"),
        // Individual walls leave a genuine doorway and interior lane. The old
        // monolithic body looked correct from outside but made the whole house
        // an opaque solid even after its collision lane was opened.
        part(
          "box",
          "back_wall",
          [0, 1.52, -1.5],
          [4.8, 2.8, 0.25],
          LONELY_STREET_MATERIALS.houseSiding,
        ),
        part(
          "box",
          "left_side_wall",
        ...
        part(
          ...
          [-1.2, 3.25, 0],
          [2.9, 0.22, 3.65],
          LONELY_STREET_MATERIALS.houseRoof,
          [0, 0, 0.48],
        ),
        part(
          "box",
        ...
        // The interactive door is authored as a separate dedicated placement
        // so its collision and transition state can change at runtime without
        // coupling its road-facing visual offset to the house mesh.
        part(
          "box",
          "door_frame_top",
          [0, 2.42, 1.72],
          [1.08, 0.12, 0.12],
          LONELY_STREET_MATERIALS.houseTrim,
        ),
        part(
          "box",
          "door_frame_left",
        ...
        part(
          ...
          [-1.5, 1.63, 1.68],
          [0.88, 0.92, 0.08],
          LONELY_STREET_MATERIALS.houseWindow,
        ),
        part(
          "box",
          "right_window",
        ...
        part(
          ...
          [0, 2.48, 1.78],
          [0.2, 0.2, 0.16],
          LONELY_STREET_MATERIALS.porchLight,
        ),
        part(
          "box",
          "chimney",
      ...
      [
        ...
        LONELY_STREET_MATERIALS.houseTrim,
        LONELY_STREET_MATERIALS.houseRoof,
        LONELY_STREET_MATERIALS.houseDoor,
        LONELY_STREET_MATERIALS.houseWindow,
        LONELY_STREET_MATERIALS.porchLight,
        "#5c4034",
        "#292d31",
    ...
    material_settings: [
      {
        id: LONELY_STREET_MATERIALS.houseSiding,
        name: "Weathered gray-green siding",
        color: "#707970",
        emissive: "#000000",
        emissive_intensity: 0,
        opacity: 1,
      ...
      {
        id: LONELY_STREET_MATERIALS.houseTrim,
        name: "Aged painted trim",
        color: "#c7c4af",
        emissive: "#000000",
        emissive_intensity: 0,
        opacity: 1,
      ...
      {
        id: LONELY_STREET_MATERIALS.houseRoof,
        name: "Dark asphalt shingles",
        color: "#262a2c",
        emissive: "#000000",
        emissive_intensity: 0,
        opacity: 1,
      ...
      {
        id: LONELY_STREET_MATERIALS.houseDoor,
        name: "Dark stained front door",
        color: "#4d382f",
        emissive: "#000000",
        emissive_intensity: 0,
        opacity: 1,
      ...
      {
        id: LONELY_STREET_MATERIALS.houseWindow,
        name: "Unlit blue-black windows",
        color: "#17252d",
        emissive: "#071014",
      ...
      {
        id: LONELY_STREET_MATERIALS.porchLight,
        name: "Weak amber porch bulb",
        color: "#ffe3a1",
        emissive: "#ffbd5d",
        emissive_intensity: 1.15,
        opacity: 1,
        transparent: false,
        roughness: 0.25,
        metalness: 0,
  ...
  },
  {
    ...object(
      ...
      "The Last House Front Door",
      "structure",
      ["door", "interactable"],
      [0.92, 2.06, 0.8],
      [
        // The placement stays centered on the authoritative doorway cell for
        // collision and interaction. This local depth offset moves only the
        // visible slab back into the house's road-facing frame.
        part(
          "box",
          "door",
          [0, 1.03, 0.64],
        ...
        part("box", "handle", [0.3, 1.06, 0.73], [0.07, 0.07, 0.05], "#b9ad79"),
      ],
      { profile: "single", footprint: [[0, 0]] },
      [LONELY_STREET_MATERIALS.houseDoor, "#b9ad79"],
    ),
    material_settings: [
      {
        id: LONELY_STREET_MATERIALS.houseDoor,
...
export const objectLibraryPresets: ObjectData[] = [
  ...baseObjectLibraryPresets.map((o): ObjectData => ({
    ...o,
  ...
  ...(baseObjectLibraryPresets.some(
    ...
    ? []
    : [MOON_GOD_MODEL]),
  ...LONELY_STREET_HOUSE_INTERIOR_OBJECTS.filter(
    (bundledObject) =>
      !baseObjectLibraryPresets.some(
        (object) => object.id === bundledObject.id,
      ),
  ),
  ...LONELY_STREET_BASEMENT_OBJECTS.filter(
    (bundledObject) =>
      !baseObjectLibraryPresets.some(
        (object) => object.id === bundledObject.id,
      ),
